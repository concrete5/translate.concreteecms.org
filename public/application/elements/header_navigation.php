...
<ul class="nav navbar-nav navbar-right">
    <li class="nav-item index-1">
        <a href="<?php echo (string)Url::to("/teams"); ?>" target="_self" class="nav-link">
            <?php echo t("Translation Teams"); ?>
        </a>
    </li>

    <li class="nav-item index-2">
        <a href="<?php echo (string)Url::to("/translate"); ?>" target="_self" class="nav-link">
            <?php echo t("Translate"); ?>
        </a>
    </li>

    <li class="nav-item index-3">
        <a href="<?php echo (string)Url::to("/translate-your-packages"); ?>" target="_self" class="nav-link">
